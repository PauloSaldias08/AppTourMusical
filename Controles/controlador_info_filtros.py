class ControladorInfoFiltros:
    def __init__(self, app):
        self.app = app

    def regresar_filtros(self):
        self.app.cambiar_frame(self.app.vista_filtros)

from Vistas.vista_info_filtros import VistaPrincipal
...
class ControladorPrincipal:
    def __init__(self, root):
        ...
        self.locales = Evento.cargar_locales("Data/eventos.json")
    ...
    def cargar_imagenes(self):
        for local in self.locales:
            imagen = ImageTk.PhotoImage(Image.open(f"Vistas/images/{local.imagen}").resize((200, 200)))
